<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "info@whathack.com";
		$email_subject = "My offer for whathack.com";
...
<html lang="en">
		<head>
				<meta charset="utf-8">
				<title>Sales Inquery || whathack.com</title>
									...
									<div class="vMiddle">
										...
										<div class="row d-md-flex text-center justify-content-center text-primary action-icons">
											...
											<div class="col-sm-4">
												...
												<p class="lead"><a href="mailto:info@whathack.com">info@whathack.com</a></p>
											</div>
									</div>
								</div>
							</div>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														<h1 class="pt-4 h2"><span class="text-green">whathack.com</span></h1>
